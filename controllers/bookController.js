// Import all books,author,genre and instances models to be use by the index controller
...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  // Get details of book and all associated instances
  ...
  res.render("book_delete", {
    title: "Delete Book",
    book: book,
    book_instance: allInstancesOfBook,
  });
});
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  ...
  if (allInstancesOfBook.length > 0) {
    // Check if book has one or more instance and return them
    res.render("book_delete", {
      title: "Delete Book",
      book: book,
      book_instance: allInstancesOfBook,
    ...
    // book has not instance go ahead an delete

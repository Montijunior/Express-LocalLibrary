...
exports.bookinstance_detail = asyncHandler(async (req, res, next) => {
  const currentBookInstance = await BookInstance.findById(req.params.id)
    .populate("book")
    .exec();
  ...
  res.render("bookinstance_detail", {
    title: "Book:",
    book_instance: currentBookInstance,
  });
});
...
exports.bookinstance_update_post = [
  ...
  asyncHandler(async (req, res, next) => {
    ...
    // Create a new book instance object with trimmed and escaped values
    const bookInstance = new BookInstance({
      book: req.body.book,
      imprint: req.body.imprint,
      status: req.body.status,
    ...
    if (!errors.isEmpty()) {
      // There are errors
      // Render the form again passing in sanitize values
